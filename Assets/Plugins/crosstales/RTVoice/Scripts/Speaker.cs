...
*/
      ...
      */
      ...
      public static Speaker Instance
      {
         ...
         {
            if (instance == null)
               instance = new GameObject("RTVoice").AddComponent<Speaker>();
      ...
      {
         get { return Instance.CustomProvider; }

         set
         {
            if (Instance.CustomProvider == value) return;
      ...
      {
         get { return Instance.CustomMode; }

         set
         {
            if (Instance.CustomMode == value) return;
      ...
      {
         get { return Instance.MaryTTSMode; }

         set
         {
            if (Instance.MaryTTSMode == value) return;
      ...
      {
         get { return Instance.MaryTTSUrl; }
      ...
      {
         get { return Instance.MaryTTSPort; }
      ...
      {
         get { return Instance.MaryTTSUser; }
      ...
      {
         private get { return Instance.MaryTTSPassword; }
      ...
      {
         get { return Instance.MaryTTSType; }
      ...
      {
         get { return Instance.ESpeakMode; }

         set
         {
            if (Instance.ESpeakMode == value) return;
      ...
      {
         get { return Instance.ESpeakModifier; }

         set { Instance.ESpeakModifier = value; }
      }
...
*/
      ...
      public void OnEnable()
      {
         ...
         else
         {
            if (!Util.Helper.isEditorMode && DontDestroy && instance != this)
            {
               ...
               {
                  Debug.LogWarning("Only one active instance of 'RTVoice' allowed in all scenes!" + System.Environment.NewLine + "This object will now be destroyed.", this);
      ...
      public static void Pause(string uid = null)
      {
         ...
         if (voiceProvider.GetType() == typeof(Provider.VoiceProviderIOS))
         {
            ...
            {
               Debug.LogWarning("'Pause' is called too fast - please slow down!");
            }
         }
         else
         {
      ...
      public static void UnPause(string uid = null)
      {
         ...
         if (voiceProvider.GetType() == typeof(Provider.VoiceProviderIOS))
         {
            ...
            {
               Debug.LogWarning("'UnPause' is called too fast - please slow down!");
            }
         }
         else
         {
