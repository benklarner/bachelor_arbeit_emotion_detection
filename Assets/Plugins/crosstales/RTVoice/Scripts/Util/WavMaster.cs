...
namespace Crosstales.RTVoice.Util
{
   ...
   public class WavMaster
   {
      ...
      /// <summary>Load PCM format *.wav audio file (using Unity's Application data path) and convert to AudioClip.</summary>
      ...
      /// <param name="offsetSamples">Offset samples inside the byte-array (default: 0, optional)</param>
      /// <param name="name">Name of the AudioClip (default: wav, optional)</param>
      /// <returns>AudioClip from the byte-array.</returns>
      ...
      /// <param name="dirname">Directory name for the files (default: rtv_audio, optional)</param>
      /// <returns>AudioClip as byte-array.</returns>
