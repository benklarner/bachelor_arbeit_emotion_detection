...
namespace Crosstales.RTVoice.Util
{
   ...
   public abstract class Helper : Common.Util.BaseHelper
   {
      ...
      public static bool hasBuiltInTTS
      {
         get
         {
            return isWindowsBasedPlatform || isAppleBasedPlatform || isAndroidPlatform || isLinuxPlatform; //|| Speaker.isCustomMode && Speaker.CustomVoiceProvider != null && Speaker.CustomVoiceProvider.isPlatformSupported;
         }
      }
